/// Hero/Home page - Main landing page with search and features
    ...
    return Drawer(
      child: ListView(
        children: [
          ...
          ListTile(leading: const Icon(Icons.flight), title: const Text('Flights'), onTap: () => Navigator.pushNamed(context, '/flights')),
          ListTile(leading: const Icon(Icons.hotel), title: const Text('Hotels'), onTap: () => Navigator.pushNamed(context, '/hotels')),
          ListTile(leading: const Icon(Icons.card_travel), title: const Text('Holiday Packages'), onTap: () => Navigator.pushNamed(context, '/offers')),
          ListTile(leading: const Icon(Icons.train), title: const Text('Trains'), onTap: () => Navigator.pushNamed(context, '/trains')),
          ListTile(leading: const Icon(Icons.directions_bus), title: const Text('Buses'), onTap: () => Navigator.pushNamed(context, '/buses')),
          ListTile(leading: const Icon(Icons.local_taxi), title: const Text('Cabs'), onTap: () => Navigator.pushNamed(context, '/cabs')),
          ListTile(leading: const Icon(Icons.luggage), title: const Text('My Trips'), onTap: () => Navigator.pushNamed(context, '/my-trips')),
          ListTile(leading: const Icon(Icons.auto_awesome), title: const Text('AI Trip Planner'), onTap: () {}),
          ListTile(leading: const Icon(Icons.login), title: const Text('Login / Sign Up'), onTap: () => Navigator.pushNamed(context, '/login')),
        ],
      ),
    );
  }
